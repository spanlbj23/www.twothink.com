<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\www\twothink\public/../application/admin/view/default/repair\index.html";i:1542121165;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="cf">
        ...
        <button class="btn list_sort" url="<?php echo url('sort',array('id'=>input('get.id'))); ?>">排序</button>
        <!-- 高级搜索 -->
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="title" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入报修人姓名">
    ...
    <div class="data-table table-striped">
        <form class="ids">
            <table>
                ...
                <tbody>
				<?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td><?php echo $repair['cont']; ?></td>
                        <!--<td>-->
                            <!--<a href="<?php echo url('toogleDev',array('id'=>$repair['id'],'value'=>abs($repair['is_dev']-1))); ?>" class="ajax-get">-->
                            <!--<?php echo $repair['is_dev_text']; ?>-->
                            <!--</a>-->
                        <!--</td>-->
                        <!--<td>-->
                            <!--<a href="<?php echo url('toogleHide',array('id'=>$repair['id'],'value'=>abs($repair['hide']-1))); ?>" class="ajax-get">-->
                            <!--<?php echo $repair['hide_text']; ?>-->
                            <!--</a>-->
                        <!--</td>-->
                        <td>
        ...
        <div class="page">
            ...
            <!--<foreach name="page" item="v">-->
                <!--<ul class="page">-->
                    <!--<li><a href="?page=1">&laquo;<?php echo $v['catid']; ?></a></li>-->
                    <!--<li><a href="?page=2">&raquo;<?php echo $v['name']; ?></a></li>-->
                <!--</ul>-->
                <!---->
            <!--</foreach>-->
    </div>
