...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '}T4Y"])?~%63kS|u2Re{lUt^h@woDp1F-W:Kra/Q', //默认数据加密KEY
	'data_cache_key'=> '}T4Y"])?~%63kS|u2Re{lUt^h@woDp1F-W:Kra/Q',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'}T4Y"])?~%63kS|u2Re{lUt^h@woDp1F-W:Kra/Q', //加密KEY
